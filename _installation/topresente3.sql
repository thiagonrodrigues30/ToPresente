...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Jul-2017 às 14:59
...
-- Database: `topresente`
--
CREATE DATABASE IF NOT EXISTS `topresente` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `topresente`;
...
(12, 1, 2, 'a:4:{i:0;i:1;i:1;i:1;i:2;i:0;i:3;i:0;}'),
(13, 1, 3, 'a:4:{i:0;i:1;i:1;i:1;i:2;i:0;i:3;i:0;}'),
(14, 1, 4, 'a:4:{i:0;i:1;i:1;i:1;i:2;i:0;i:3;i:0;}');
...
(1, 'CK123', 'Arquitetura de Computadores', 1, 1, 4);
...
--
ALTER TABLE `aulas`
  ADD PRIMARY KEY (`aula_id`), ADD KEY `turma_id` (`turma_id`);
...
ALTER TABLE `presencas`
  ADD PRIMARY KEY (`presenca_id`), ADD KEY `turma_id` (`turma_id`), ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `turmas`
--
ALTER TABLE `turmas`
  ADD PRIMARY KEY (`turma_id`), ADD KEY `inst_id` (`inst_id`), ADD KEY `user_id` (`user_id`);

--
-- Indexes for table `users`
--
ALTER TABLE `users`
  ADD PRIMARY KEY (`user_id`), ADD UNIQUE KEY `user_name` (`user_name`), ADD UNIQUE KEY `user_email` (`user_email`), ADD KEY `inst_id` (`inst_id`);
